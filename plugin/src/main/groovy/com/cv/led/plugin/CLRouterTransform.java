...
public class CLRouterTransform extends Transform {
     ...
     */
    private static final String INIT_SERVICE_DIR = Const.GEN_PKG_SERVICE.replace('.', File.separatorChar);
    /**
     * com/sankuai/waimai/router/generated/service
     */
    private static final String INIT_SERVICE_PATH = Const.GEN_PKG_SERVICE.replace('.', '/');
